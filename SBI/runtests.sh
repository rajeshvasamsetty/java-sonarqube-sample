...
mvn -U -s settings.xml -Dmaven.package.skip=true -Dmaven.test.skip=true -Dmaven.compile.skip=true deploy sonar:sonar -Dsonar.login=$SONARUSER_TOKEN -Dsonar.issuesReport.html.enable=true -Dsonar.projectName=sonar-report
